...
<section class="no-padding main-slider height-100 mobile-height wow fadeIn ">
    <div class="swiper-full-screen height-100 width-100 black-move">
        <div class="swiper-wrapper">
            <!-- start slider item -->
            <div class="swiper-slide cover-background" style="background-image:url({{ asset('/images/home/slider/slide1.jpg') }});">
            ...
            <!-- end slider item -->
            <!-- start slider item -->
            <div class="swiper-slide cover-background" style="background-image:url({{ asset('/images/home/slider/slide2.jpg') }});">
                <div class="container position-relative full-screen">
                    <div class="col-md-12 slider-typography text-center text-md-left">
                        <div class="slider-text-middle-main">
                            <div class="slider-text-middle">
...
<section class="padding-four-tb" style="background-color: #61d2fa;">
    <div class="container">
        <div class="row program-benefits">
            ...
            <div class="col-md-4 text-dark text-large">
                <ul>
                    <li>Take assessments to test your skill</li>
                </ul>
            </div>
            <div class="col-md-8 justify-content-center">
    ...
    <div class="container">
        <div class="row program-benefits">
            ...
            <div class="col-md-12 text-dark text-large justify-content-center d-flex">
                <a href="https://github.com/emekambachu/alx-project-elearning-and-assessment-portal.git" target="_blank" class="btn bg-light-purple btn-rounded btn-large no-margin-lr">Github</a>
