...
@section('content')
<section class="wow fadeIn parallax padding-five-tb" data-stellar-background-ratio="0.5" style="background-image: url(&quot;{{ asset('images/register-bg.jpg') }}&quot;);
...
<section class="wow fadeIn" style="visibility: visible; animation-name: fadeIn; padding-top: 12px;">
    <div class="container">
        <div class="row position-relative">
            ...
            <div class="col-12 swiper-slide md-margin-four-bottom margin-10px-bottom" style="width: 375px;">
                <h4 class="text-navy-blue text-inter">Meet the Team</h4>
            </div>

            <div class="col-md-4 swiper-slide md-margin-four-bottom margin-10px-bottom" style="width: 375px;">
                <div class="team-box bg-medium-light-gray margin-half-all bg-white box-shadow-light text-center padding-nine-all sm-padding-18px-all">
                    <img src="{{ asset('/images/team/victor.jpeg') }}" class="rounded-circle width-80 margin-25px-bottom md-margin-15px-bottom" alt="Victor Chukwuemeka Mbachu">

                    <div class="icon-social-small">
                        <a href="https://www.linkedin.com/in/victor-mbachu/" target="_blank" class="text-navy-blue">
                            <i class="fab fa-2x fa-linkedin"></i></a>
                        <a href="https://www.twitter.com/dexmbachu" target="_blank" class="text-navy-blue">
            ...
            <div class="col-md-4 swiper-slide md-margin-four-bottom margin-10px-bottom" style="width: 375px;">
                <div class="team-box bg-medium-light-gray margin-half-all bg-white box-shadow-light text-center padding-nine-all sm-padding-18px-all">
                    <img src="{{ asset('/images/team/moses-isang.jpg') }}" class="rounded-circle width-80 margin-25px-bottom md-margin-15px-bottom" alt="Victor Chukwuemeka Mbachu">

                    <div class="icon-social-small">
                        <a href="https://www.linkedin.com/in/mosesisang223?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" class="text-navy-blue">
                            <i class="fab fa-2x fa-linkedin"></i>
                        </a>
                        <a href="https://twitter.com/isang_moses?t=-NorggJmuTYcQSOwfHpC2w&s=09" target="_blank" class="text-navy-blue">
            ...
            <div class="col-md-4 swiper-slide md-margin-four-bottom margin-10px-bottom" style="width: 375px;">
                <div class="team-box bg-medium-light-gray margin-half-all bg-white box-shadow-light text-center padding-nine-all sm-padding-18px-all">
                    <img src="{{ asset('/images/team/chioma.jpg') }}" class="rounded-circle width-80 margin-25px-bottom md-margin-15px-bottom" alt="dr-debisi-araba">

                    <div class="icon-social-small">
                        <a href="https://www.linkedin.com/me?trk=p_mwlite_feed_updates-secondary_nav" target="_blank" class="text-navy-blue">
                            <i class="fab fa-2x fa-linkedin"></i></a>
                    </div>
            ...
            <div class="col-md-4 swiper-slide md-margin-four-bottom margin-10px-bottom" style="width: 375px;">
                <div class="team-box bg-medium-light-gray margin-half-all bg-white box-shadow-light text-center padding-nine-all sm-padding-18px-all">
                    <img src="{{ asset('/images/team/wasiu.jpg') }}" class="rounded-circle width-80 margin-25px-bottom md-margin-15px-bottom" alt="ernest-habanabakize">

                    <div class="icon-social-small">
                        <a href="https://www.linkedin.com/in/abdulwasiu-siyanbola-972616203/" target="_blank" class="text-navy-blue">
