...
import {
    ...
    import AdminModuleAssignmentSubmissionItem from "./AdminModuleAssignmentSubmissionItem.vue";
    ...
    const getAssignments = (page = 1) => {
        ...
        axios.get('/api/admin/module/assignments/submissions?page=' + page, {
            headers: {
    ...
    const searchAssignments = (page = 1) => {
        ...
        axios.post('/api/admin/module/assignments/submissions/search?page=' + page, form, {
            headers: {
                "Authorization" : "Bearer " + localStorage.getItem('afc-admin-tk'),
                'Accept' : 'application/json',
            },
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form @submit.prevent="searchAssignments" style="margin-bottom: 4px;">
                    <div class="row p-3">
                        <div class="col-12">
                        ...
                        <div class="col-md-6" style="margin-bottom: 10px;">
                            ...
                            <input class="form-control" type="text" v-model="form.terms">
                        </div>
...
<!--                            </a>-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered small table-hover table-responsive-sm mb-0">
                                ...
                                <template v-if="dataLoaded">
                                    <admin-module-assignment-submission-item
    ...
    <laravel-vue-pagination v-if="searchActive"
                            ...
                            :limit="3"
                            :data="assignments"
                            @pagination-change-page="searchAssignments"
    >
        <template #prev-nav>
            <span>&lt; Previous</span>
        </template>
