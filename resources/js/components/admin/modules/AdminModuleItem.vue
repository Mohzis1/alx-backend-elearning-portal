<template>
    <tr v-if="!deleted">
        ...
        <td width="40%">
            <strong>Courses:</strong> {{ module.courses.length }}<br>
            <strong>Assignment Submissions:</strong> {{ module.assignment_submissions.length }}<br>
            <strong>Started Module:</strong> {{ module.started_module_assessments }}<br>
            <!--i included minus 4 due to a mistake in the module id 7 and 8-->
            <strong>Completed Module:</strong> {{ [7, 8].includes(module.id) ? module.completed_module_assessments - 4 : module.completed_module_assessments }}<br>
            <strong>Passed Module:</strong> {{ module.passed_module_assessments.length }}<br>
        </td>
        ...
        <td width="20%">
            ...
            <router-link
                exact
                class="btn btn-info btn-sm mr-1"
                :to="{name: 'AdminModuleAssignmentSubmissionView', params: {id: module.id}}">
