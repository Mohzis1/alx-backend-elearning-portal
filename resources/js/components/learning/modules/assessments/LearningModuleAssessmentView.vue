            ...
            <div class="col-12">
                <div class="row p-3 justify-content-center d-flex">
                    ...
                    <TransitionGroup name="slide-fade">
                        ...
                        <!--Questions-->
                        <div v-if="questionsView" class="col-12 col-md-8">
                            <div v-if="!questions_message" class="bg-white-radius-shadow border-light-green">
                                <form>
                            ...
                            <div v-else class="bg-white-radius-shadow border-light-green">
                                <p class="text-inter text-center">{{ questions_message }}</p>
                            </div>
                        </div>
                        ...
                        <div v-if="completionView" class="col-12 text-center">
                            ...
                            <div v-if="passed === true">
                                <p class="text-center tx-16">
                                    ...
                                    <strong>
                                        Your Score: <span class="na-text-dark-green">{{ roundToTwoDecimals(percent) }}%</span>
                                    </strong>
                                </p>

                                <!--If next module exists-->
                                <div v-if="module.next_module">
                                    <p class="tx-16">Click on ‘Next Module’ to proceed to the next module.</p>
                                    <router-link
                                        exact
                                        :to="{name: 'LearningCourseView', params: {id: module.next_module.id}}">
                                        <button class="start-assessment-btn na-bg-dark-green text-white mt-2">
                                            Next Module</button>
                                    </router-link>
                                </div>
                                ...
                                <div v-else>
                                    <p class="text-center tx-16">
                                        You have successfully completed all modules, feel free to retake some assessments to get a higher score or look at your assessment history
                                    </p>
                                    <router-link
                                        exact
                                        :to="{name: 'LearningModuleView'}">
...
export default {
    setup(){
        ...
        const roundToTwoDecimals = (num) => {
            return BaseService.roundToTwoDecimal(num);
        }
