...
class CourseResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'current_course_completed' => CourseService::currentCourseCompleted(Auth::user()->id, $this->id, $this->module->id),
            'next_course' => CourseService::getNextCourse($this->sort, $this->module->id) ?? false,
            'previous_course' => CourseService::getPreviousCourse($this->sort, $this->module->id) ?? false,
