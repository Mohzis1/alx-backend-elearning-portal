...
use App\Models\Member\InvestmentReadinessPortfolio;
...
class CourseResourceService
{
    ...
    public function downloadResource($id): \Symfony\Component\HttpFoundation\BinaryFileResponse
    {
        $document = $this->resourceById($id);
        $path = public_path(). '/'.$this->documentPath.'/'. $document->document;
