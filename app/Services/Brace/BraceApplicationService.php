...
class BraceApplicationService
{
    ...
    public function storeApplication($request): array
    {
        ...
        $inputs['participated_previous_program'] .= ', ' . $inputs['participated_previous_program_yes'];
        $inputs['participated_climate_program'] .= ', ' . $inputs['participated_climate_program_yes'];
        $inputs['how_did_you_hear'] .= ', ' . $inputs['how_did_you_hear_others'];
